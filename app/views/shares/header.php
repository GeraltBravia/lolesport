...
<head>
    ...
    <link rel="stylesheet" href="public/css/style.css"> <!-- Giữ CSS tùy chỉnh của bạn -->
</head>
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    if (SessionHelper::get('user_id')): ?>
                        <span class="me-2">Xin chào, <?php echo htmlspecialchars(SessionHelper::getUsername()); ?></span>
                        <a class="btn btn-danger" href="/project-esports/auth/logout">Đăng xuất</a>
                    <?php else: ?>
